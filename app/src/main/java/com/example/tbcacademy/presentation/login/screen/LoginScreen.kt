package com.example.tbcacademy.presentation.login.screen
...
import com.example.tbcacademy.presentation.login.vm.LoginViewModel
        ...
        onSideEffect = { effect ->
            when (effect) {
                LoginSideEffect.LoginToProfile ->
                    navigator.navigate(Routes.CATALOGUE)
