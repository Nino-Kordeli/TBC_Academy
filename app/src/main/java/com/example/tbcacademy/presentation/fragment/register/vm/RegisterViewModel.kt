package com.example.tbcacademy.presentation.fragment.register.vm
...
import com.example.tbcacademy.presentation.fragment.register.contract.RegisterState
    ...
    private fun register() = viewModelScope.launch {
        ...
        registerUseCase(email, password).collect { result ->
            when (result) {
                ...
                is Resource.Error -> emitSideEffect(RegisterSideEffect.ShowToast(result.message))
